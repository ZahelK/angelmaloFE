...
createRoot(document.getElementById("root")).render(
  <StrictMode>
    <App />
    <div className="flex flex-col justify-center p-2 font-normal text-blue-100 w-100 m-auto">
      <div className="bg-white/20 p-0.5 rounded-lg bg-gradient-to-br from-yellow-400 to-amber-600">
        <div className="p-2 bg-blue-950 rounded-sm">
          ...
          <p className="text-transparent bg-clip-text bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-600">
            Registrate antes del 1 de noviembre para participar por un cupón de 15 lucas para gastar en lo que quieras!
